...
public extension LivePhoto {
    ...
    ///
    static func camera(_ completion: @escaping LivePhotoDataCompletion) throws -> some View {
...
public extension LivePhoto {
    ...
    ///
    static func browser(_ completion: @escaping ResultLivePhotoCompletion) throws -> some View {
